...
const DonationItemFormThree = ({
  ...
  const {
    ...
    defaultValues: {
      name: formData?.donationItems?.[2]?.name,
      current: formData?.donationItems?.[2]?.current,
      needed: formData?.donationItems?.[2]?.needed,
    },
  });
...
export default DonationItemFormThree;
